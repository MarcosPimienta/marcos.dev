      ...
      <div className="scroll-container scrollable-custom">
        <Section
          ...
          teaser={
            <div className="paragraph">
              Full-Stack Developer & 3D Web Enthusiast bringing together
          ...
          <div className="profile-container">
            <div style={{ flex: 1 }}>
              <p className="paragraph">
                Full-Stack Developer & 3D Web Enthusiast Bringing together
                innovation and efficiency to craft high-impact web applications,
                immersive 3D experiences, and scalable digital solutions.
              </p>
            </div>
          </div>
        </Section>
        ...
        >
          <div className="education-entry">
            <div>
              <strong>Media Arts & Animation BSc</strong>, The Art Institute of
              Fort Lauderdale
            </div>
          </div>
        </Section>
