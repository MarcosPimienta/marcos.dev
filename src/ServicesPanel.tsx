    ...
    <div className="services-panel">
      ...
      >
        <ul>
          ...
          <li>
            Scalable application architecture with real-world deployment
            patterns
          </li>
          <li>
            Relational Database schema design, indexing strategy, migrations
            (Postgres, MySQL)
          </li>
          <li>Authentication/authorization, validation, security hardening</li>
          <li>
            Testing strategy: unit, integration, end-to-end for confidence in
            releases
          </li>
        </ul>
      </Section>
      ...
      >
        <ul>
          ...
          <li>
            Educational simulations with seasonal/environmental transitions
          </li>
          <li>
            Custom data visualizations augmented with particle & scene effects
          </li>
          <li>Performance-conscious WebGL integration in web apps</li>
          <li>
            Interactive 3D maps with geospatial layers and data integration
          </li>
        </ul>
      </Section>
      ...
      >
        <ul>
          ...
          <li>
            Responsive layouts, accessibility compliance, cross-device
            consistency
          </li>
          ...
          <li>
            Tool-like dashboards and control panels with clear affordances
          </li>
        </ul>
      </Section>
      ...
      >
        <ul>
          ...
          <li>
            Code quality practices: reviews, linters, typing, documentation
          </li>
      ...
      >
        <ul>
          <li>
            Containerization (Docker) and orchestration (Kubernetes patterns)
          </li>
          ...
          <li>
            Environment reliability (local staging, reproducible dev setups,
            WSL/VSCode troubleshooting)
          </li>
        </ul>
      </Section> */}
    </div>
